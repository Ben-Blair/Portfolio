  ...
  return (
    <div
      ...
      className={cn(
        ...
        lift ? "duration-[440ms]" : "duration-[380ms]",
      )}
    ...
    >
      ...
      <div
        className={cn(
          ...
          lift ? "min-h-0 duration-[440ms]" : "overflow-hidden duration-200",
      ...
      >
        ...
        <div
          className={cn(
            ...
            lift &&
              cn(
                "transition-transform duration-[440ms] ease-out motion-reduce:transition-none",
