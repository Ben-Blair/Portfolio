...
// The typing dots live in `./TypingDots`. They're the opening frame of `/projects`'s loading
// shell as well as part of a turn here, and that shell can't afford this module's media imports.
